...
const { client_id, client_secret, redirect_uri, expoRedirect } = require('../config/keys');
logger_1.default.log(expoRedirect);
...
router.get('/refresh_token', async (req, res) => {
    ...
    const result = await fetch('https://accounts.spotify.com/api/token', authOptions).catch(e => {
        console.log('e:', e);
        throw e;
    });
